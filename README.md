...
- `dist/OffTick-0.1.0.zip`
- `dist/OffTick-0.1.0.zip.sha256`
- `dist/RELEASE_NOTES-0.1.0.md`
...
1. Upload `OffTick-0.1.0.zip` to the GitHub Release.
2. Paste the generated SHA256 value from `OffTick-0.1.0.zip.sha256`.
3. Paste the generated release notes from `RELEASE_NOTES-0.1.0.md`.
...
1. 上传 `OffTick-0.1.0.zip` 到 GitHub Release。
2. 把 `OffTick-0.1.0.zip.sha256` 里的 SHA256 值贴到 Release notes。
3. 把 `RELEASE_NOTES-0.1.0.md` 里的说明贴到 Release notes。
