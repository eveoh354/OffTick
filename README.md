...
1. Upload `OffTick-0.2.1.zip` to the GitHub Release.
2. Paste the generated SHA256 value from `OffTick-0.2.1.zip.sha256`.
3. Paste the generated release notes from `RELEASE_NOTES-0.2.1.md`.
...
1. 上传 `OffTick-0.2.1.zip` 到 GitHub Release。
2. 把 `OffTick-0.2.1.zip.sha256` 里的 SHA256 值贴到 Release notes。
3. 把 `RELEASE_NOTES-0.2.1.md` 里的说明贴到 Release notes。
